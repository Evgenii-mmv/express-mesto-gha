...
/**
 * Я не знаю почему на запрос пользователя по айди(который проверяет корректный случай запроса),
 * автотест делает запрос по пути users/null,
 * и из-за этого автотесты на функциональность валятся, если вписать туда id пользователя,
 * то все работает
 */
